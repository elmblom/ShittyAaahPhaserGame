...
export default class Scene0 extends Phaser.Scene {
    ...
    create() {
        ...
        // Title / UI
        this.add.sprite(w / 2, h / 2, "sky").setScale(0.7 * Scene0.resMult).setOrigin(0.5);
        const logo = this.add.sprite(w / 2, 150 * Scene0.resMult, "logo").setScale(0.6 * Scene0.resMult).setOrigin(0.5);
        const playText = this.add.text(w / 2, 290 * Scene0.resMult, "Press Space To Start", { fontFamily: "Arial", fontSize: 28 * Scene0.resMult, color: "#ffffff", stroke: "#000000", strokeThickness: 6 }).setOrigin(0.5);
